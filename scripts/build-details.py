...
@media (max-width: 719px) { .nav-toggle { display: flex; } nav.primary { display: none; flex-basis: 100%; } nav.primary.open { display: block; max-height: calc(100vh - 64px); overflow-y: auto; -webkit-overflow-scrolling: touch; overscroll-behavior: contain; } nav.primary > ul { flex-direction: column; gap: 0; padding-top: 10px; margin-top: 10px; border-top: 1px solid rgba(232,227,216,0.12); } nav.primary > ul > li { width: 100%; } nav.primary a { display: block; padding: 11px 0; border-bottom: 1px solid rgba(232,227,216,0.12); } .nav-more-btn { border: 0; padding: 11px 0; font-size: 11px; } .lang-btn { border: 0; margin: 0; font-size: 11px; } }
