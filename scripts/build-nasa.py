...
/* LIGHTBOX */
.lightbox { position: fixed; inset: 0; background: rgba(0,0,0,0.96); display: none; align-items: center; justify-content: center; z-index: 200; padding: 32px; }
...
.lb-inner img, .lb-inner video, .lb-inner iframe { max-width: 90vw; max-height: 82vh; }
.lb-inner img, .lb-inner video { border: 1px solid var(--rule-strong); background: #000; }
.lb-inner iframe { width: 90vw; height: 82vh; border: 1px solid var(--rule-strong); background: #000; }
